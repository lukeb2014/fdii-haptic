 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = C:/Users/User/workspace_v10/simple_serial_socket_server_app_CC26X2R1_LAUNCHXL_tirtos_ccs/Release/configPkg/package/cfg/simple_serial_socket_server_app_pem4f");
